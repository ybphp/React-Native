...
export default class Register extends Component{
          ...
          <SafeAreaView style={styles.container}>
            <ScrollView style={{flex: 1}}>
              ...
              <ListRow title='验  证  码' detail={
                ...
                <Button title='注册' size='md' type='primary' style={styles.signBtn} onPress = {this._onSubmit} />
            </ScrollView>
          </SafeAreaView>
      );
  }
  ...
  //提示框
  showCustom() {
    if (Register.customKey) return;
    Register.customKey = Toast.show({
      text: '正在注册',
  ...
  _onSubmit = () => {
    ...
    let url = config.domain.http + config.domain.register;
